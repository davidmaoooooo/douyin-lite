...
(async function(){
  ...
  Date.now=()=>1700000256000;Math.random=()=>0.5;performance.now=()=>12345;
  window.Date=class extends _OD{constructor(...a){if(a.length===0)super(1700000256000);else super(...a);}static now(){return 1700000256000;}};
...
if __name__ == "__main__":
    ...
    for k, v in o["longs"].items():
        print(f"  {k}: {v[:8]}")
    o["a_bogus"] = a_bogus
    json.dump(o, open("lib/abogus_rebuild/paired_t256.json", "w"), ensure_ascii=False, indent=1)
    print("\nsaved paired_t256.json")
