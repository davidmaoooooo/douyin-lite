...
if __name__ == "__main__":
    ...
    cdp.cmd("Runtime.evaluate",{"expression":"""
      (function(){Date.now=()=>1700000000000;Math.random=()=>0.3;performance.now=()=>12345;
    ...
    for i in range(len(plains)-1):
        if plains[i]==171 and plains[i+1]==85:
            ...
            break
    json.dump({"plains":plains,"kss":kss}, open("lib/abogus_rebuild/rc4_xors_r3.json","w"))
    print("\nsaved rc4_xors_r3.json")
